<template>
  <div class="dropdown" :class="{'show': isOpen}">
    <button type="button" class="button dropdown__toggle" :class="{'dropdown__toggle_icon': hasIcon}" @click="dropdownButtonHandler">
      <app-icon v-if="selectedIcon" :icon="selectedIcon" />
      {{ selectedTitle }}
    </button>
...
export default {
  ...
  computed: {
    ...
    selectedTitle() {
      return `${this.title}${this.selectedOption ? ` - ${this.selectedOption.text}` : ''}`;
    },
    hasIcon() {
